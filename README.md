...
Using past data, my model learns how different types of advertising affect sales — and then predicts future results.
...
4. **Model Training** – Used a **Linear Regression** model to teach the computer how ad budgets influence sales.  
5. **Model Testing** – Verified accuracy using test data and performance metrics.  
6. **Visualization** – Plotted graphs to show how close predictions were to actual results.  
7. **New Predictions** – Gave the model new ad budgets to predict expected sales.
...
- The importance of testing models with new data.  
- That even small datasets can reveal meaningful business insights.
...
- The final model reached around **90% accuracy (R² ≈ 0.9)**, which shows strong prediction ability.  
...
🔗 [Advertising Dataset on GitHub](https://raw.githubusercontent.com/z33shxn/Sales-Prediction-CodSoft-/refs/heads/main/advertising.csv)
...
3. The notebook will automatically load the dataset and generate all results and graphs.
...
This marks one of my first steps in my journey as a Data Science learner and AI enthusiast 🚀
